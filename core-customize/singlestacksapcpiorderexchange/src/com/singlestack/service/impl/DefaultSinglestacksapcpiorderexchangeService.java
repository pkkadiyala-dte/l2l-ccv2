...
public class DefaultSinglestacksapcpiorderexchangeService implements SinglestacksapcpiorderexchangeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSinglestacksapcpiorderexchangeService.class);
	...
	{
		return DefaultSinglestacksapcpiorderexchangeService.class.getResourceAsStream("/singlestacksapcpiorderexchange/sap-hybris-platform.png");
	}
