 ...
 */
package com.l2l.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(L2lFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(L2lFulfilmentProcessConstants.PARENT_PROCESS);
