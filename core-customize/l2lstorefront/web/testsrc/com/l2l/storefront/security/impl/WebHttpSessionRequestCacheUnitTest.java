...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/l2lstorefront/electronics/en",
						"https://electronics.local:9002/l2lstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/l2lstorefront/electronics/en",
						"https://electronics.local:9002/l2lstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/l2lstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/l2lstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/l2lstorefront/electronics/en",
						"https://electronics.local:9002/l2lstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/l2lstorefront",
						"https://electronics.local:9002/l2lstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/l2lstorefront",
						"https://electronics.local:9002/l2lstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/l2lstorefront/electronics/en",
						"https://electronics.local:9002/l2lstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
