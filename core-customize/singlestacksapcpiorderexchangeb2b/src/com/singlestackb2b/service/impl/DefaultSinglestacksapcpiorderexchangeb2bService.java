...
public class DefaultSinglestacksapcpiorderexchangeb2bService implements Singlestacksapcpiorderexchangeb2bService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSinglestacksapcpiorderexchangeb2bService.class);
	...
	{
		return DefaultSinglestacksapcpiorderexchangeb2bService.class.getResourceAsStream("/singlestacksapcpiorderexchangeb2b/sap-hybris-platform.png");
	}
