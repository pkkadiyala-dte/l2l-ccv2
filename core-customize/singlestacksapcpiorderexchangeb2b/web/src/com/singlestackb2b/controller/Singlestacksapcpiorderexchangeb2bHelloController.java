 ...
 */
package com.singlestackb2b.controller;
...
@Controller
public class Singlestacksapcpiorderexchangeb2bHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", singlestacksapcpiorderexchangeb2bService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
