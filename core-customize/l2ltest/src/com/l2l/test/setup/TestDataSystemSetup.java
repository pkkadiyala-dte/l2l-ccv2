...
import com.l2l.test.constants.L2lTestConstants;
import com.l2l.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = L2lTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/l2ltest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/l2ltest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/l2ltest/import/cstickets.impex");
			...
			importImpexFile(context, "/l2ltest/import/csquotes.impex");
		}
	}
}
