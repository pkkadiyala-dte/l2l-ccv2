 ...
 */
package com.l2l.core.constants;

/**
 * Global class for all L2lCore constants. You can add global constants for your extension into this class.
 */
public final class L2lCoreConstants extends GeneratedL2lCoreConstants
{
	public static final String EXTENSIONNAME = "l2lcore";


	private L2lCoreConstants()
	{
		//empty
	}
